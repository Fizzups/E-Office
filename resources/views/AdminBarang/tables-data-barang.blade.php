		...
		<div class="modal fade" id="addRowModal" tabindex="-1" role="dialog" aria-hidden="true">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form id="add_barang" action={{ url('data-barang') }} method="POST">
							@csrf
							<div class="row">
								<div class="col-sm-12">
									<div class="form-group form-group-default"> <label>Nama Barang</label> 
								...
								<div class="col-sm-6">
									<div class="form-group form-group-default"> <label>Satuan Barang</label> <input name="satuan_barang" type="text" value="{{ old('satuan_barang') }}"
											class="form-control @error('nama') is-invalid @enderror">
										@error('satuan_barang')
											<div class="text-danger">{{ $message }}</div>
										@enderror
								...
								<div class="col-sm-6">
									<div class="form-group form-group-default"> <label>Jumlah Barang</label> <input name="jumlah_barang" type="text" value="{{ old('jumlah_barang') }}"
											class="form-control @error('nama') is-invalid @enderror">
										@error('jumlah_barang')
											<div class="text-danger">{{ $message }}</div>
										@enderror
					...
					<div class="modal-footer no-bd">
						<a href="javascript:history.back()" class="btn btn-warning"> Batal</a>
						<button onclick="submitAddForm()" name="" type="submit" class="btn btn-primary mr-2"> Tambah</button>
					</div>
					</form>
					<script>
						function submitAddForm() {
													...
													<td>
														...
														<div class="form-button-action">
															<button type="button" data-toggle="modal" 
																...
																data-original-title="Edit" data-id="{{$row->id}}" 
															...
															<form action="{{ route('delete.barang', $row->id) }}" method="POST">
																...
																@csrf
																@method('delete')	 
																<button data-toggle="modal" title="delete" 
											...
											<div class="modal fade" id="editModal{{ $row->id }}" tabindex="-1" 
												...
												<div class="modal-dialog" role="document">
													<div class="modal-content">
														...
														<div class="modal-body">
															<form id="edit_barang" action={{ route('update.barang', $row->id) }} method="POST">
																@method('PUT')
																@csrf
																<div class="row">
																	<div class="col-sm-12">
																	...
																	<div class="col-sm-6">
																		<div class="form-group form-group-default"> <label>Satuan Barang</label>
																			<input 
																			name="satuan_barang" type="text" 
																			value="{{ old('satuan_barang') ?? $row->satuan_barang }}"
																	...
																	<div class="col-sm-6">
																		<div class="form-group form-group-default"> <label>Jumlah Barang</label>
																			<input 
																			name="jumlah_barang" type="text" 
																			value="{{ old('jumlah_barang') ?? $row->jumlah_barang }}"
																			class="form-control @error('nama') is-invalid @enderror">
																			@error('jumlah_barang')
																				<div class="text-danger">{{ $message }}</div>
																			@enderror
														...
														<div class="modal-footer no-bd">
															<a href="javascript:history.back()" class="btn btn-warning"> Batal</a>
															<button onclick="submitAddForm()" name="edit" type="submit" class="btn btn-primary mr-2"> Submit</button>
														</div>
														@endforeach
														</form>
														<script>
	...
	<script>
        $(document).ready(function() {
            ...
            $('.btnDelete').click(function(e) {
				...
				swal({
					title: "Yakin?",
					text: "Anda akan menghapus data "+barangnama+"!",
					icon: "warning",
					buttons: true,
					dangerMode: true,
				})
				.then((willDelete) => {
					if (willDelete) {
						window.location ="data-barang/delete/"+barangid+""
						swal("Data "+barangnama+" telah dihapus!", {
						icon: "success",
						});
					} else {
						swal("Data "+barangnama+" tidak jadi dihapus!");
					}
				});
            });
