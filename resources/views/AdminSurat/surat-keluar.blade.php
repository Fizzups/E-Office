		...
		<div class="modal fade" id="addRowModal" tabindex="-1" role="dialog" aria-hidden="true">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form id="add_surat-keluar" action={{ url('surat-keluar') }} 
							...
							<div class="row">
								<div class="col-sm-6">
									<div class="form-group form-group-default">
                                        ...
                                        <input name="tanggal_keluar_surat" type="date" value="{{ old('tanggal_keluar_surat') }}" 
										class="form-control @error('tanggal_keluar_surat') is-invalid @enderror">
										@error('tanggal_keluar_surat')
								...
								<div class="col-sm-12">
									<div class="form-group form-group-default"> 
                                        <label>Tujuan</label> 
                                        <input name="tujuan_surat" type="text" value="{{ old('tujuan_surat') }}"
								...
								<div class="col-sm-12">
                                    <div class="form-group form-group-default">
										...
										<textarea class="form-control" id="comment" rows="3" name="perihal"></textarea>
										@error('perihal')
											<div class="text-danger">{{ $message }}</div>
										@enderror
								...
								<div class="col-sm-12">
                                    <div class="form-group form-group-default">
										...
										<input type="file" class="form-control-file mt-3" id="exampleFormControlFile2" name="dokumen"
					...
					<div class="modal-footer no-bd">
						...
						class="btn btn-primary mr-2 btnAdd"> Tambah</button>
					</div>
					</form>
					<script>
						function submitAddForm() {
							$('#add_surat-keluar').submit();
				...
				<div class="page-inner">
					<div class="page-header">
						...
						<ul class="breadcrumbs">
							...
							<li class="nav-item">
								<a href="/data-karyawan">Surat Keluar</a>
							</li>
						</ul>
					</div>
					<div class="row">
							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										...
										<button class="btn btn-primary btn-round ml-auto" data-toggle="modal" data-target="#addRowModal" style="">
                                        ...
                                        <table id="basic-datatables" class="display table table-striped table-hover" >
											<thead>
												<tr>
                                                    ...
                                                    <th>Foto</th>
                                                    <th>Dokumen</th>
													<th style="width: 1%" align-text="center">Aksi</th>
												</tr>
											</thead>
											<tfoot>
												<tr>
                                            ...
                                            <tbody>
												<?php $i=1;?>
												@foreach ($surat_keluar as $data_surat_keluar)
												<tr> 
													<td>{{$i++}}</td>
													<td>{{$data_surat_keluar->tanggal_surat}}</td>
													<td>{{$data_surat_keluar->tanggal_keluar_surat}}</td>
													<td>{{$data_surat_keluar->nomor_surat}}</td>
													<td>{{$data_surat_keluar->tujuan_surat}}</td>
													<td>{{$data_surat_keluar->perihal}}</td>
													<td class="text-center" style="width:1%">
														<div class="uk-file-img mr-3" uk-grid uk-lightbox="animation: slide">
															<div>
																<a class="uk-inline" href="{{asset('assets/img/FileSuratKeluar/'.$data_surat_keluar->foto)}}">
																	<img src="{{asset('assets/img/FileSuratKeluar/'.$data_surat_keluar->foto)}}" class="m-2" width="1800" height="1200" alt="">
																</a>
															</div>
														</div>
													</td>
													<td class="text-center" style="width:1%">
														<div class="uk-file-img mr-3">
															<div>
																<a class="uk-inline" href="{{asset('assets/img/FileSuratKeluar/'.$data_surat_keluar->dokumen)}}">Dokumen</a>
															</div>
														</div>
													</td>
													<td>
														<form action="{{ route('delete.surat-keluar', $data_surat_keluar->id) }}" method="POST">
														@csrf
	                      								@method('delete')
															<div class="form-button-action">
																<button type="button" data-toggle="tooltip" data-target="#editModal" title="" class="btn btn-link btn-primary btn-lg" data-original-title="Edit">
																	<i class="fa-solid fa-pen-to-square"></i>
																</button>
																<button type="button" data-toggle="tooltip" title="" class="btn btn-link btn-danger btnDelete" data-original-title="Delete" data-id="{{$data_surat_keluar->id}}">
	...
	<script>
        $(document).ready(function() {
			...
			$('.btnDelete').click(function(e) {
                e.preventDefault();
				var suratkeluarid = $(this).attr('data-id');
				...
				.then((willDelete) => {
					if (willDelete) {
						window.location ="surat-keluar/delete/"+suratkeluarid+""
